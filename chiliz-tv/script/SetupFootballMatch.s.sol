...
contract SetupFootballMatch is Script {
    ...
    function _printSummary() internal view {
        ...
        console.log("=============================================");
        console.log("");
        console.log("Bet 100 USDC on Home Win (Market 0, Selection 0):");
        console.log("  Step 1: Approve USDC");
        console.log("  cast send <USDC_ADDRESS> 'approve(address,uint256)'", matchAddress, "100000000");
        ...
        console.log("    'placeBetUSDC(uint256,uint64,uint256)'");
        console.log("    0 0 100000000");
        console.log("    --rpc-url https://spicy-rpc.chiliz.com --legacy --with-gas-price 2501");
        console.log("    --private-key $PRIVATE_KEY");
        console.log("");
        console.log("Bet 50 USDC on Over 2.5 goals (Market 1, Selection 1):");
        console.log("  cast send", matchAddress);
        console.log("    'placeBetUSDC(uint256,uint64,uint256)'");
        console.log("    1 1 50000000");
        console.log("    --rpc-url https://spicy-rpc.chiliz.com --legacy --with-gas-price 2501");
        console.log("    --private-key $PRIVATE_KEY");
        console.log("");
        console.log("=============================================");
